...
description: Den här artikeln innehåller information om hur du prenumererar på och distribuerar Project Operations för scenarier som inte finns i lager.
author: sigitac
ms.date: 07/02/2021
ms.topic: article
