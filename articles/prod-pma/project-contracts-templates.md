...
description: Den här artikeln beskriver de mallar och underliggande uppgifter som används för att synkronisera projektkontrakt och projekt direkt från Microsoft Dynamics 365 Project Service Automation till Dynamics 365 Finance.
author: Yowelle
ms.date: 12/17/2020
ms.topic: article
ms.prod: ''
...
Den här artikeln beskriver de mallar och underliggande uppgifter som används för att synkronisera projektkontrakt och projekt direkt från Dynamics 365 Project Service Automation till Dynamics 365 Finance.
...
Använd Microsoft Power Query för Excel för att filtrera data om följande villkor uppfylls:
...
Om du måste använda Power Query följer du riktlinjerna nedan:
