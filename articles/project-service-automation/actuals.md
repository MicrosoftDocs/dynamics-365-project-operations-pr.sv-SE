...
## <a name="using-journals-to-record-costs"></a>Använda journaler för att registrera kostnader

I PSA kan du med hjälp av journaler registrera kostnader eller intäkter i transaktionsklasserna material, avgift, tid, utgift eller moms. En journal har ett huvud, rader och en **Bekräfta**-åtgärd. Här följer några scenarier där du kan använda en journal:
