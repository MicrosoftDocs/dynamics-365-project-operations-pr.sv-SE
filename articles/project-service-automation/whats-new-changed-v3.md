...
1.  Eftersom **Bokningsbar resurs**, som är ett fält i entiteten **Tidspost** inte visas på sidan **snabbregistrering** måste du lägga till det.
    ...
    Skapa en anpassad vy om du endast vill visa tidsposter som har skapats för resursen. Publicera anpassningarna för appmoduldesignern för att den här vyn ska visas under **visningsväljare** på sidan **tidsposter**. Det finns två plugin-program som hanterar inställning av ansvarig för tidsposter som inte är projektrelaterade:
