...
4. Om du inte använder Spencer Low med användarnamn **spencerl**, måste du uppdatera en ytterligare fil. Öppna **DemoDataPreImportConfig.xml**-filen och sök **userstocreateandconfigure**-etiketten. Uppdatera **\<inloggning\>**-etiketten med användarnamnet för din Spencer Low användare. Mer information finns i [tekniska anteckningar](#technical-notes).
...
4. Om användarens fullständiga namn ”Spencer Low” har en annan användare än **”spencerl”** måste du uppdatera en ytterligare fil. Öppna **DemoDataPreImportConfig.xml** och sök **userstocreateandconfigure**-etiketten. Uppdatera etiketten **\<inloggning\>** med loginId (skiftlägeskänsligt). 
...
- **\<EntitiesToEnableScheduling\>** anger vilka entiteter som ska aktiveras för bokning i Microsoft Dynamics schemaläggning (även kallat Universal Resource Scheduling).
