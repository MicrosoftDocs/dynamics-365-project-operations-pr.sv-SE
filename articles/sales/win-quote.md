---
title: Stäng projektbaserade offerter
description: Den här artikeln innehåller information om att stänga offerter i Project Operations.
author: rumant
ms.date: 10/01/2020
ms.topic: article
...
ms.locfileid: "9824240"
---
# <a name="close-project-based-quotes"></a>Stäng projektbaserade offerter

_**Gäller:** Project Operations för resurs-/icke-lagerbaserade scenarier_

En projektoffert kan stängas som **Vunnen** eller **Förlorad**. 
