...
description: I den här artikeln finns information om hur prissättning fungerar i Dynamics 365 Project Service Automation.
author: rumant
ms.custom:
...
Dynamics 365 Project Service Automation utökar entiteten för prislista i Dynamics 365 Sales. 
...
- **Datum** - den här entiteten används när systemet försöker ange ett standardpris i en transaktion. PSA-prissättning väljer den prislista som har giltighetsdatum som omfattar datumet för transaktionen. Om PSA-prissättningen söker efter mer än en prislista som är giltig för transaktionsdatumet är kopplat till den relaterade offerten, kontraktet eller organisationsenheten blir inget pris standard. 
...
Personaltider anges vanligtvis utifrån den roll som en resurs fyller i ett specifikt projekt. För personaltid har PSA stöd för kostnadsberäkning och fakturering baserat på resursroll. Tid kan vara pris i valfri enhet i enhetsgruppen för **tid**.
...
Resekostnader och andra utgifter som ingår i projektkonsulter faktureras vanligen till kunden. PSA har stöd för prissättning av utgiftskategorier med hjälp av prislistor. Flyg, hotell och hyrbil är exempel på utgiftskategorier. Varje rad i en prislista för utgifter anger prissättningen för en specifik utgiftskategori. För prissättning av utgiftskategorier stöder PSA följande tre prissättningsmetoder:
...
När en projektpris lista är kopplad till en försäljningsenhet verifierar PSA följande information:

- Prislistan har kontexten **försäljning**. 
- Prislistans valuta matchar kundvalutan. 

I ett projektkontrakt använder PSA följande prioriteringsordning för att automatiskt ange relaterade projektprislistor:
...
När en projektprislista anges som standard verifierar PSA att valutan överensstämmer med kundens valuta och att standardprislistorna som har angetts har kontexten **försäljning**.
...
I PSA kan du skapa detaljerade åsidosättningar för valda priser på projektprislistor som anges som standard i en offert eller ett projektkontrakt.
...
PSA spårar kostnader för användning av tid för mänsklig resurs i projekt. Dessutom spåras kostnaderna för andra utgifter som inträffat under projektet, t.ex. resekostnader.
