...
När en dimension för anpassad prissättning är alternativbaserad lägger du till den som ett fält för att viktiga entiteter i Project Service. I följande procedur används **Resursens arbetsplats** och **Arbetstid för resurs** används som alternativuppsättningsbaserade prissättningsdimensioner. Dessa måste först läggas till som fält till prissättningsentiteter **Rollpris** och **Pålägg för rollpris**.

1. I Project Service Automation (PSA), klicka på **Inställningar** > **Lösningar** och dubbelklicka sedan på **\<your organization name> prissättningsdimensioner**. 
...
I faserna försäljning och beräkning för projektet beräknas arbetsinsatsen för varje standardrubrik för priset för offerten/projektet. Detta innebär att 1 till N-relationer från Standardrubrik till var och en av dessa beräkningsentiteter i Project Service behövs: 
...
| Project Service-entitet        | Formulär som behöver det nya fältet   |Vyer som behöver det nya fältet      |
| ------------------------------|---------------------------------|----------------------------------|
