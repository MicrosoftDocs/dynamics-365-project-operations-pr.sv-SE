...
description: Denna artikel innehåller information och exempel som hjälper dig att använda loggarna för projektschemaläggning i syfte att spåra problem som är relaterade till API:er för projektschemaläggning och tjänsten Projektschemaläggning.
author: ruhercul
ms.date: 11/30/2021
ms.topic: article
