...
- Om du skapar en ny mall måste du lägga till den här kolumnen. I Power Query, välj **Lägg till villkorlig kolumn** och ange ett namn för den nya kolumnen, t.ex. **ModelID**. Ange villkoret för kolumnen, där om projektaktiviteten inte är null \<ange modell-ID för prognos\>; annars null.
...
- Om du skapar en ny mall måste du lägga till den här kolumnen. I Power Query, välj **Lägg till villkorlig kolumn** och ange ett namn för den nya kolumnen, t.ex. **ModelID**. Ange villkoret för kolumnen, där om uppskatta rad-ID inte är null \<ange modell-ID för prognos\>; annars null.
