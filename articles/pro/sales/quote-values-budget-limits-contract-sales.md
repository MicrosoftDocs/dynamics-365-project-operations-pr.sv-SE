---
title: Rubrikinformation för projektofferter
description: Den här artikeln innehåller information om den information och de inställningar som gäller för och hur projektofferter påverkas. (Sales)
author: rumant
ms.date: 10/01/2020
ms.topic: article
