...
description: Den här artikeln innehåller information om fält som påverkar kontraktrader och den information om kontraktet som sammanfattas för alla radobjekt.
author: rumant
ms.date: 03/08/2022
ms.topic: article
