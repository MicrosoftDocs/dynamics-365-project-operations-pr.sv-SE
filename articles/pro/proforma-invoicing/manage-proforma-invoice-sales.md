...
description: Den här artikeln ger information om hur du arbetar med proforma-projektfakturor.
author: rumant
ms.date: 04/05/2021
ms.topic: article
...
### <a name="create-new-invoice-line-details"></a>Skapa nya fakturaraddetaljer

På tids- och materialfakturarader kan du skapa nya fakturaraddetaljer. Dessa fakturaraddetaljer stöds inte av verkliga värden. På fakturaraden för en tid- och materialfakturarad kan du välja **Ny** om du vill skapa en ny fakturaradinformation för de transaktionsklasser som är inkluderade på kontraktraden.
...
## <a name="product-based-invoice-lines"></a>Produktbaserade fakturarader
