...
description: Denna artikel förklarar hur du importerar och underhåller utgiftsrelaterade kreditkortstransaktioner. Dessa transaktioner kan ställas in så att de importeras automatiskt till ett återkommande schema, eller så kan de importeras manuellt efter behov.
author: KimANelson
ms.date: 01/12/2018
ms.topic: article
ms.prod: ''
